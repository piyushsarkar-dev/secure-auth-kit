const page = () => {
  return (
    <div className="grid h-dvh place-items-center">
      <div className="product-card group relative z-[100] flex w-[300px] shrink-0 cursor-pointer snap-start flex-col items-center justify-center gap-3 overflow-hidden rounded-md bg-white px-6 py-8 shadow-xl transition-all duration-300">
        <div className="absolute top-0 -left-[40%] transition-all duration-300 group-hover:scale-150 group-hover:rotate-12">
          <div className="flex gap-1">
            <svg
              ...
              fill="none"
              viewBox="0 0 24 24"
              className="rotate-[24deg] fill-gray-300"
              height="200"
              width="200"
        ...
        <div className="absolute top-[44%] left-1/2 z-20 h-[110%] w-[110%] -translate-x-1/2 rounded-full bg-gray-500 transition-all duration-300 group-hover:top-[58%]"></div>
        <div className="para z-40 text-center leading-none uppercase">
          <p className="font-serif text-xs font-semibold text-black">ADMIN</p>
          <p className="text-xl font-bold tracking-wider text-gray-500">
            Welcome Back
          </p>
        </div>
        <div className="img z-40 aspect-square w-[180px] rounded-md bg-gray-100">
          <svg
            xmlSpace="preserve"
        ...
        <div className="btm-_container z-40 flex flex-row items-end justify-between gap-10">
            ...
            <div className="inline-flex items-center justify-center gap-3">
              <div className="flex items-center justify-center rounded-full bg-white p-1">
                <svg
                  ...
                  fill="none"
                  viewBox="0 0 24 24"
                  className="h-3 w-3 fill-gray-800 stroke-none"
                  xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="inline-flex items-center justify-center gap-3">
                <div className="flex items-center justify-center rounded-full bg-white p-1">
                  <svg
                    ...
                    fill="none"
                    viewBox="0 0 24 24"
                    className="h-3 w-3 fill-gray-800 stroke-white"
                    xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="btn">
            <button className="rounded-full bg-white px-2 py-1 text-xs font-semibold whitespace-nowrap text-gray-800 uppercase">
              ORDER NOW
            </button>
          </div>
        </div>
